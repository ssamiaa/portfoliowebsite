...
export default function About() {
  return (
    <section
      id="about"
      className="pt-20 pb-0 text-gray-900 bg-origin-padding flex flex-col items-center"
    >
      ...
      <div className="mb-8">
        <TypeAnimation
          ...
          speed={50}                             
          className="text-4xl font-bold text-center mb-4 text-purple-950 "
          cursor={true}                          
          repeat={Infinity}                      
        />
      </div>

      <div className="max-w-7x-l grid grid-cols-2 grid-rows-3 gap-8">
        {/* Top Left: Current Positions */}
        <div className="bg-white shadow-md p-6 rounded-lg border h-200 border-gray-200">
          <h3 className="text-xl font-bold text-purple-950 mb-4">Currently a...</h3>
        ...
        <div className="bg-white h-100 shadow-md p-6  h-50 rounded-lg border border-gray-200">
          ...
          <ul className="list-disc pl-3 space-y-2">
            ...
            <li>How Socks Always Go Missing</li>
          </ul>
        </div>
